...
Map<String, String> get getMl => {
      'CONNECT': 'ബന്ധിപ്പിക്കുക',
      'Connect devices to the same network - use Wi-Fi or Mobile Hotspot':
          'ഒരേ ശൃംഖലയിലുള്ള ഡിവൈസുകൾ തമ്മിൽ ബന്ധിപ്പിക്കുക - വൈ-ഫൈയോ മൊബൈൽ ഹോട്സ്പോട്ടോ ഉപയോഗിക്കുക',
      'SEND': 'അയക്കുക',
      ...
      'Mobile Hotspot': 'മൊബൈൽ ഹോട്സ്പോട്ട്',
      'Connect to': 'ബന്ധിപ്പിക്കുക',
      'or set up a': 'അല്ലെങ്കിൽ ക്രമീകരിക്കുക ഒരു',
      ' Mobile Hotspot': ' മൊബൈൽ ഹോട്സ്പോട്ട്',
      ...
      'Text': 'എഴുത്ത്',
      'App': 'ആപ്പ്',
      'Hide system apps': 'സിസ്റ്റം ആപ്പുകൾ മറയ്ക്കുക',
      'Hide non-launchable apps': 'ലോഞ്ച് ചെയ്യാനാവാത്ത ആപ്പുകൾ മറയ്ക്കുക',
      'Search': 'തിരയുക',
      //v2.1
      'Updates': 'അപ്ഡേറ്റുകൾ',
